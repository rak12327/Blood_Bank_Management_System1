...
import {
  abNegativeBloodDetail,
  abPositiveBloodDetail,
  aNegativeBloodDetail,
  aPositiveBloodDetail,
  bNegativeBloodDetail,
  bPositiveBloodDetail,
  oNegativeBloodDetail,
  oPositiveBloodDetail,
} from "../../Redux/Request/ComopentNameSlice";
    ...
    <div className="">
      ...
      <div className="max-w-[1300px] mx-auto max-h-[90vh] h-[100%] px-[1rem] pt-[1rem]">
        <div className="text-center">
          <h1 className="text-[crimson] text-4xl font-bold">
            Check Blood Stock
          </h1>
        </div>
            ...
            <div className="bg-[red] w-[100%] h-[100%] text-center flex items-center justify-between rounded-[.5rem]">
              <div className="flex justify-center w-[40%] basis-[40%]">
                <img
                  src={"/assets/b1.png"}
                  alt={"..."}
                  className="w-[6rem] h-[8rem] duration-500"
                />
              </div>
              <div className="bg-[#fff] h-[80%] basis-[60%] rounded-lg mr-[1rem]">
                ...
                <div className="text-center my-[.5rem]">
                  <label
                    htmlFor="option"
                    className="block mb-[.2rem] text-left px-[.1rem]"
                  >
                    Blood Component:
                  </label>
                  <select
                    name="option"
                    id="option"
                    className="w-[90%] px-[.5rem] py-[.3rem] focus:rounded option text-[.65rem]"
                    onChange={(e) =>
                      setInput({ ...input, positiveA: e.target.value })
                    }
                  >
                ...
                <div className="mb-[.5rem] w-[100%]">
                  <label htmlFor="price" className="text-sm w-[30%]">
                    Unit{" "}
                  </label>
                  <input
                    type="text"
                    disabled
                    value={data?.aPositiveBlood?.unit || 0}
                    className="w-[70%] text-sm px-[.5rem] py-[.4rem] unitValue"
                  />
                </div>
                <button
                  className="px-[.5rem] py-[.1rem] bg-[black] rounded text-[#fff]"
                  onClick={() => {
                    data.aPositiveBlood
                      ? data.aPositiveBlood.unit > 0
                        ? dispatch(
                            openBloodDetailsModel({
                              ...data.aPositiveBlood,
                              unit: 1,
                            })
                          )
                        : toast(
                            "You can't order blood now, Please try again later",
                            { type: "warning", theme: "colored" }
                          )
                      : toast("Select Blood Name", {
                          theme: "colored",
                          type: "warning",
                        });
                  }}
              ...
              <div className="bg-[#fff] h-[80%] basis-[60%] rounded-lg mr-[1rem]">
                ...
                <div className="text-center my-[.5rem]">
                  ...
                  <select
                    name="option"
                    id="option"
                    className="w-[90%] px-[.5rem] py-[.3rem] text-[.65rem] focus:rounded option"
                    onChange={(e) =>
                      setInput({ ...input, negativeA: e.target.value })
                    }
                  >
                    <option value="null">Select</option>
                ...
                <div className="mb-[.5rem] w-[100%]">
                  ...
                  <input
                    type="text"
                    disabled
                    value={data?.aNegativeBlood?.unit || 0}
                    className="w-[70%] text-sm px-[.5rem] py-[.4rem] unitValue"
                  />
                </div>
                <button
              ...
              <div className="bg-[#fff] h-[80%] basis-[60%] rounded-lg mr-[1rem]">
                ...
                <div className="text-center my-[.5rem]">
                  ...
                  <select
                    ...
                    className="w-[90%] px-[.5rem] py-[.3rem] text-[.65rem] focus:rounded option"
                    onChange={(e) =>
                      setInput({ ...input, positiveB: e.target.value })
                    }
                  >
                    <option value="null">Select</option>
                ...
                <div className="mb-[.5rem] w-[100%]">
                  ...
                  <input
                    type="text"
                    disabled
                    value={data?.bPositiveBlood?.unit || 0}
                    className="w-[70%] text-sm px-[.5rem] py-[.4rem] unitValue"
                  />
                </div>
                <button
              ...
              <div className="bg-[#fff] h-[80%] basis-[60%] rounded-lg mr-[1rem]">
                ...
                <div className="text-center my-[.5rem]">
                  ...
                  <select
                    ...
                    className="w-[90%] px-[.5rem] py-[.3rem] text-[.65rem] focus:rounded option"
                    onChange={(e) =>
                      setInput({ ...input, negativeB: e.target.value })
                    }
                  >
                    <option value="null">Select</option>
                ...
                <div className="mb-[.5rem] w-[100%]">
                  ...
                  <input
                    type="text"
                    disabled
                    value={data?.bNegativeBlood?.unit || 0}
                    className="w-[70%] text-sm px-[.5rem] py-[.4rem] unitValue"
                  />
                </div>
                <button
              ...
              <div className="bg-[#fff] h-[80%] basis-[60%] rounded-lg mr-[1rem]">
                ...
                <div className="text-center my-[.5rem]">
                  ...
                  <select
                    ...
                    className="w-[90%] px-[.5rem] py-[.3rem] text-[.65rem] focus:rounded option"
                    onChange={(e) =>
                      setInput({ ...input, positiveAB: e.target.value })
                    }
                  >
                    <option value="null">Select</option>
                ...
                <div className="mb-[.5rem] w-[100%]">
                  ...
                  <input
                    type="text"
                    disabled
                    value={data?.abPositiveBlood?.unit || 0}
                    className="w-[70%] text-sm px-[.5rem] py-[.4rem] unitValue"
                  />
                </div>
                <button
                  className="px-[.5rem] py-[.1rem] bg-[black] rounded text-[#fff]"
                  onClick={() => {
                    data.abPositiveBlood
                      ? data.abPositiveBlood.unit > 0
                        ? dispatch(
                            openBloodDetailsModel({
                              ...data.abPositiveBlood,
                              unit: 1,
              ...
              <div className="bg-[#fff] h-[80%] basis-[60%] rounded-lg mr-[1rem]">
                ...
                <div className="text-center my-[.5rem]">
                  ...
                  <select
                    ...
                    className="w-[90%] px-[.5rem] py-[.3rem] text-[.65rem] focus:rounded option"
                    onChange={(e) =>
                      setInput({ ...input, negativeAB: e.target.value })
                    }
                  >
                    <option value="null">Select</option>
                ...
                <div className="mb-[.5rem] w-[100%]">
                  ...
                  <input
                    type="text"
                    disabled
                    value={data?.abNegativeBlood?.unit || 0}
                    className="w-[70%] text-sm px-[.5rem] py-[.4rem] unitValue"
                  />
                </div>
                <button
                  className="px-[.5rem] py-[.1rem] bg-[black] rounded text-[#fff]"
                  onClick={() => {
                    data.abNegativeBlood
                      ? data.abNegativeBlood.unit > 0
                        ? dispatch(
                            openBloodDetailsModel({
                              ...data.abNegativeBlood,
                              unit: 1,
              ...
              <div className="bg-[#fff] h-[80%] basis-[60%] rounded-lg mr-[1rem]">
                ...
                <div className="text-center my-[.5rem]">
                  ...
                  <select
                    ...
                    className="w-[90%] px-[.5rem] py-[.3rem] text-[.65rem] focus:rounded option"
                    onChange={(e) =>
                      setInput({ ...input, positiveO: e.target.value })
                    }
                  >
                    <option value="null">Select</option>
                ...
                <div className="mb-[.5rem] w-[100%]">
                  ...
                  <input
                    type="text"
                    disabled
                    value={data?.oPositiveBlood?.unit || 0}
                    className="w-[70%] text-sm px-[.5rem] py-[.4rem] unitValue"
                  />
                </div>
                <button
              ...
              <div className="bg-[#fff] h-[80%] basis-[60%] rounded-lg mr-[1rem]">
                ...
                <div className="text-center my-[.5rem]">
                  ...
                  <select
                    ...
                    className="w-[90%] px-[.5rem] py-[.3rem] text-[.65rem] focus:rounded option"
                    onChange={(e) =>
                      setInput({ ...input, negativeO: e.target.value })
                    }
                  >
                    <option value="null">Select</option>
                ...
                <div className="mb-[.5rem] w-[100%]">
                  ...
                  <input
                    type="text"
                    disabled
                    value={data?.oNegativeBlood?.unit || 0}
                    className="w-[70%] text-sm px-[.5rem] py-[.4rem] unitValue"
                  />
                </div>
                <button
