...
export const SignInThunk = createAsyncThunk("signin", async ({ value, navigate, state, enqueueSnackbar, setValue }, { rejectWithValue }) => {
    ...
    try {
        ...
        } else if (error.message === "Network Error" || error?.response?.data?.message === `Can't find ${signInLink} on this server!`) {
